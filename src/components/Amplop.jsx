...
const Amplop = () => {
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="absolute top-0 left-0 right-0 bottom-0 max-w-md mx-auto amplop h-screen z-[99] font-arima "
      >
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute text-center left-1/2 -translate-x-1/2 bottom-28 text-white text-shadow min-w-72">
          <h3 data-aos="zoom-in" className="font-cormorant">
            THE WEDDING OF
          </h3>
          <h1 data-aos="zoom-in" className="text-3xl my-5">
            Putri & Putra
          </h1>
          <h3 data-aos="zoom-in" className="my-5 text-lg">
            Kepada Yth.{' '}
            <div className="font-semibold">{formatName(guestName)}</div>
          </h3>
          <button
            onClick={handleInvitationOpened}
            className="mt-20 text-center bg-purple-950 py-2 px-3 mx-auto rounded-full text-purple-50 animate-bounce"
          >
